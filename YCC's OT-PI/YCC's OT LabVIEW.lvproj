...
<Project Type="Project" LVVersion="14008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Main-Calibration" Type="Folder" URL="../Main-Calibration">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Main-Force Clamp" Type="Folder" URL="../Main-Force Clamp">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Main-Laser Feedback" Type="Folder" URL="../Main-Laser Feedback">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Main-Stage-PI" Type="Folder" URL="../Main-Stage-PI">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Main-Strech DNA" Type="Folder" URL="../Main-Strech DNA">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="new-Stablize z -axis" Type="Folder" URL="../new-Stablize z -axis">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Orther VI" Type="Folder" URL="../Orther VI">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="Passive Force Clamp_YCC" Type="Folder" URL="../Passive Force Clamp_YCC">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="TestVI" Type="Folder" URL="../TestVI">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="VI-Math" Type="Folder" URL="../VI-Math">
			<Property Name="NI.DISK" Type="Bool">true</Property>
		</Item>
		<Item Name="PowerMeter(ThorLabs)-v4.vi" Type="VI" URL="../../AOM/PowerMeter(ThorLabs)-v4.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="(SubVI) Acquire precise position_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) Acquire precise position_YCC.vi"/>
			<Item Name="(SubVI) ADC(read) Rate Options_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) ADC(read) Rate Options_YCC.vi"/>
			<Item Name="(SubVI) Get Real Position to Deal with Stage Offset_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) Get Real Position to Deal with Stage Offset_YCC.vi"/>
			<Item Name="(SubVI) Set Scanrate and Pull_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) Set Scanrate and Pull_YCC.vi"/>
			<Item Name="(SubVI) Slowly Go to Target Posiiton_YCC-v2.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) Slowly Go to Target Posiiton_YCC-v2.vi"/>
			<Item Name="(SubVI) Slowly Go to Target Posiiton_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) Slowly Go to Target Posiiton_YCC.vi"/>
			<Item Name="(SubVI) Stage Waveform Trigger_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) Stage Waveform Trigger_YCC.vi"/>
			<Item Name="(SubVI) Write and Read Waveform.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) Write and Read Waveform.vi"/>
			<Item Name="(SubVI) XY information for Stage and DAQ channel_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) XY information for Stage and DAQ channel_YCC.vi"/>
			<Item Name="(SubVI) XYZ information for Stage and DAQ channel_YCC.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/(SubVI) XYZ information for Stage and DAQ channel_YCC.vi"/>
			<Item Name="Analog_Configuration_Setup.vi" Type="VI" URL="../Main-Stage-PI/GCS_LabVIEW/Analog_Configuration_Setup.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="Madlib.dll" Type="Document" URL="../Main-Stage-Based/SubVI-Stage-Based/MCL-dll-Labview 32-bit/Madlib.dll"/>
			...
			<Item Name="RampGenerator.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/RampGenerator.vi"/>
			<Item Name="Select INSTR Dialog.vi" Type="VI" URL="../../YYH&apos;s OT/Main-Laser Feedback/Thorlab-LabViewExample/Select INSTR Dialog.vi"/>
			<Item Name="stage READ 10.vi" Type="VI" URL="../QPD cal/Common VIs/STAGE contorl_ subVI/stage READ 10.vi"/>
			<Item Name="stage read_v2.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/stage read_v2.vi"/>
			<Item Name="stage WRITE.vi" Type="VI" URL="../QPD cal/Common VIs/STAGE contorl_ subVI/stage WRITE.vi"/>
			<Item Name="stage write_v2.vi" Type="VI" URL="../Main-Stage-Based/SubVI-Stage-Based/stage write_v2.vi"/>
